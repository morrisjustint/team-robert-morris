...
export default function TeamRobertMorris() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F7F4] text-[#1A2A3A]">
      ...
      {/* HERO - Cinematic & Welcoming */}
      <section className="relative h-[92vh] min-h-[620px] flex items-center justify-center bg-[#0F1C2E] text-white overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(#ffffff15_0.8px,transparent_1px)] bg-[length:4px_4px]"></div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              ...
              className="btn-gold px-10 py-4 rounded-full text-lg font-semibold shadow-lg"
            >
              I&apos;m a First-Time Buyer
            </button>
            <button 
              onClick={() => scrollToSection('contact')}
              className="btn-outline border-white text-white px-10 py-4 rounded-full text-lg font-semibold hover:bg-white hover:text-[#0F1C2E]"
            >
              Talk With Our Team
            </button>
          </div>
      ...
      <section id="areas" className="section bg-[#0F1C2E] text-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {areas.map((area, idx) => (
              <div key={idx} className="area-card card bg-white text-[#1A2A3A] p-7 rounded-2xl group cursor-pointer" onClick={() => scrollToSection('contact')}>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left">
            <div className="card p-9">
              <div className="text-[#C5A46E] text-4xl mb-4">“</div>
              <p className="text-lg leading-relaxed">“Team Robert Morris made our first home purchase feel manageable and even exciting. They explained every step clearly and never made us feel rushed. We couldn’t be happier with our home in Franklin.”</p>
            ...
            <div className="card p-9">
              <div className="text-[#C5A46E] text-4xl mb-4">“</div>
              <p className="text-lg leading-relaxed">“After 40 years in the business, Robert and his team still treat every client like family. Their knowledge of Middle Tennessee is unmatched. We sold our home quickly and for top dollar.”</p>
              <div className="mt-8 text-sm">
      ...
      <section className="section max-w-4xl mx-auto px-6">
        ...
        <div className="card max-w-2xl mx-auto p-2 shadow-xl">
          <div className="bg-[#F8F7F4] rounded-xl p-6 h-[380px] flex flex-col">
            {/* Chat Messages */}
            <div className="flex-1 overflow-y-auto pr-2 space-y-1 mb-4" id="chat-window">
            ...
            <form onSubmit={handleChatSubmit} className="flex gap-3">
              <input
                ...
                placeholder="Ask anything... e.g. “What should a first-time buyer know about Franklin?”"
      ...
      <footer className="bg-[#0F1C2E] text-white/70 py-12 text-sm">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-12 gap-y-10">
          ...
          <div className="md:col-span-4 text-sm">
            ...
            <div className="mt-6 text-xs">© {new Date().getFullYear()} Team Robert Morris • Onward Realty</div>
          </div>
        </div>
      </footer>
      ...
      {chatOpen && (
        <div className="fixed bottom-24 right-6 z-[60] w-[380px] max-w-[calc(100vw-3rem)] card shadow-2xl overflow-hidden">
          ...
          <div className="p-4 h-[340px] overflow-y-auto bg-[#F8F7F4] text-sm" id="floating-chat">
            {chatMessages.map((msg, index) => (
